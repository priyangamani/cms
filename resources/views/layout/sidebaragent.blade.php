  ...
  <section class="sidebar">
    ...
    <!-- /.search form -->
      ...
      <ul class="sidebar-menu " data-widget="tree">
        ...
        <li> <a href="{{route('agentdashboard',['user_id'=>$agents->user_id])}}"><i class="fa fa-tachometer"></i>
          <span class="hide-menu">Dashboard</span></a>
        </li>

        <li> <a href="{{route('appformdetails',['user_id'=>$agents->user_id])}}"><i class="fa fa-wpforms"></i>
          <span class="hide-menu">App-Form</span></a>
        </li>

        <li> <a href="{{route('appforms',['user_id'=>$agents->user_id])}}"><i class="fa fa-cart-plus"></i>
