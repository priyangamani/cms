                    ...
                    <form action="#" method="POST" id="frm-profile-edit" enctype ="multipart/form-data">
                      ...
                      <div class="form-horizontal">
                        ...
                        <div class="box-body">
                          ...
                          <br>
                          <!-- SECTION 2 --><h4><u><b>APPLICANT INFORMATION</b></u></h4><br>
...
$('#frm-profile-edit').on('submit',function(e){
  ...
  var formData = new FormData($(this)[0]);
    ...
    $.ajax({
      url:"{{route('updateManAdminAppform',['user_id'=> $managers->user_id,'appform_id'=> $appforms->appform_id])}}", 
      type: "POST",
      data: formData,
      async: false,
