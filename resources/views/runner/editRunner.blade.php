        ...
        <div class="tab-pane active" id="tab_1">
          <div class="box">
            ...
            <div class="modal-body">
              <!-- Custom Tabs (Pulled to the right) -->
              <form action="#" method="POST" id="frm-runner-edit" enctype ="multipart/form-data">
                {!! csrf_field() !!}
                <div class="row">
...
<script>
  $('#frm-runner-edit').on('submit',function(e){
    e.preventDefault();
    console.log('pressed');
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        $("[data-dismiss = modal]").trigger({type: "click"});
          swal('SUCCESS', 'Runner Updated', 'success').then(function() {
        window.location.replace("{{route('runner')}}");
         });
