        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <!-- <p><a href="{{route('appforms',['user_id'=> $agents->user_id])}}" style="color:#fff"><b>TOTAL APPLICANTS</b></a></p> -->
              <p style="color:#fff"><b>TOTAL APPLICATION FORM</b></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p style="color:#fff"><b>SUBMIT FOR APPROVAL</b></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p style="color:#fff"><b>PENDING APPLICANT</b></p>
            </div>
            <div class="icon">
              <i class="fa fa-ban"></i>
            </div>
