                    ...
                    <form action="#" method="POST" id="frm-profile-edit" enctype ="multipart/form-data">
                      ...
                      <div class="form-horizontal">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="company_name" id="company_name" value="{{$appforms->company_name}}" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="buss_reg_num" id="buss_reg_num" value="{{$appforms->buss_reg_num}}" disabled>
                          </div>
                        </div>
