      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" >Add Runner</h4>
      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs ">
            ...
            <li class="pull-right"> 
            <!-- <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#add-user">Add Runner</button></li> -->
          </ul>
              ...
              <div class="box">
                  ...
                  <tbody>        
                   ...
                   <tr class="info">
                    ...
                    <td class="mailbox-name"><center><a href="{{route('runnerdashboard',['user_id'=>$user->user_id])}}">{{$user->name}}</a></center></td>
                    ...
                    <td class="mailbox-name"><center><div class="btn-group">
                      <a class="button btn btn-success btn-sm" href="{{route('editRunner', ['user_id'=> $user->user_id])}}"><i class="fa fa-gear"></i>Edit</a>
...
$(document).ready(function(){
    ...
    $('#frm-user-create').on('submit',function(e)
    {
        ...
        $.ajax(
        {
          ...
          swal('SUCCESS', 'Runner Added', 'success').then(function() {
