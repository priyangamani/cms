...
@section('content')
    ...
    <section class="content-header">
      <h1>
        PENDING APPROVAL APPLICATION-FORM 
                      ...
                      <table class="table table-striped" id="appform-table">
                        ...
                        <tbody>        
                         ...
                         <tr class="info">
                          ...
                          <td class="mailbox-star"><center>{{$appform->ic}}</center></td>
                          @endif
                          <td class="mailbox-star"><center><a href="{{route('pendingdataprofile',['user_id'=> $admins->user_id, 'appform_id'=> $appform->appform_id])}}">{{$appform->appform_id}}</a></center></td>
