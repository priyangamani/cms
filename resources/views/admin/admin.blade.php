      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs ">
            ...
            <li class="pull-right"> 
            <!-- <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#add-user">Add Admin</button></li> -->
          </ul>
              ...
              <div class="box">
                  ...
                  <tbody>        
                   ...
                   <tr class="info">
                    ...
                    <td class="mailbox-name"><center><a href="{{route('admindashboard',['user_id'=>$user->user_id])}}">{{$user->name}}</a></center></td>
                    ...
                    <td class="mailbox-name"><center><div class="btn-group">
                      <a class="button btn btn-success btn-sm" href="{{route('editAdmin', ['user_id'=> $user->user_id])}}"><i class="fa fa-gear"></i>Edit</a>
