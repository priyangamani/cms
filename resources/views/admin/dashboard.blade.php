...
<section class="content">
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <a href="{{route('adminappforms',['user_id'=> $admins->user_id,'status'=>1])}}">
          <div class="small-box bg-green">
            <div class="inner">
              <h3>{{$completeapplicant}}</h3>
              <p style="color:#fff"><b>COMPLETE APPLICANT</b></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <a href="{{route('adminappforms',['user_id'=> $admins->user_id,'status'=>2])}}">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>{{$incompleteapplicant}}</h3>

              <p style="color:#fff"><b>INCOMPLETE APPLICANT</b></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <a href="{{route('adminappforms',['user_id'=> $admins->user_id,'status'=>3])}}">
          <div class="small-box bg-red">
            <div class="inner">
              <h3>{{$pendingapplicant}}</h3>
              <p style="color:#fff"><b>CANCELLED APPLICANT</b></p>
            </div>
            <div class="icon">
              <i class="fa fa-ban"></i>
            </div>
