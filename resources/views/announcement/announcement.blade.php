  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="#" method="POST" id="frm-ann-create">
          {!! csrf_field() !!}
          <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" name="ann_title" id="ann_title">
              </div>
            </div>
                ...
                <table class="table table-hover table-striped" id="ann-table">
                  ...
                  <tbody>
                    ...
                    <tr class="info">
                      ...
                      <td class="mailbox-subject"><center>{{$announcement->ann_picture}}</center></td>
